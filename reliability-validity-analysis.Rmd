---
title: "Reliability and Validity Analysis"
author: Daniel A. Gundersen, PhD<br/>DanielA_Gundersen@dfci.harvard.edu<br/>Survey and
  Data Management Core<br/>Dana-Farber Cancer Institute
...
tobacco_1 <- c("user", "non-user", "non-user", "non-user", "non-user", 
               "non-user", "non-user", "non-user", "non-user", "non-user")

tobacco_2 <- c("non-user", "user", "non-user", "non-user", "non-user",
               "non-user", "non-user", "non-user", "non-user", "non-user")

table(tobacco_1, tobacco_2)

agree(tibble(tobacco_1, tobacco_2))

kappa2(tibble(tobacco_1, tobacco_2))
...
* Difference in mean of `r round(mean_diff, 1)`
